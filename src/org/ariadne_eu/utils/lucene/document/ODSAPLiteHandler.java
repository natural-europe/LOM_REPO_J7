...
public class ODSAPLiteHandler extends DocumentHandler {
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (tmpBranche.matches(".*classification.*")) {
			...
			if (tmpBranche.contains("langstring")) {
				tmpBranche = tmpBranche.replace("langstring", "string");
			}
		...
		// Title
			...
			if (tmpBranche.endsWith("title.langstring")) {
		...
		else if (tmpBranche.matches(".*general.keyword.langstring")) {
			String format = elementBuffer.toString().toLowerCase().trim();
		...
		// typicalagerange.string
			...
			contents = contents.concat(" "
					+ elementBuffer.toString().toLowerCase());
		} else if (tmpBranche.matches(".*typicalagerange.langstring.*")) {
			tmpBranche = tmpBranche.substring(0, tmpBranche.lastIndexOf("."))
					+ ".string";
			doc.add(new Field(tmpBranche.toLowerCase(), elementBuffer
					.toString().toLowerCase(), Field.Store.YES,
